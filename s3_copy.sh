...
do
   aws s3 --region ap-south-1 rm s3://ekstep-public-$1/content-plugins/$i/ 
   aws s3 --region ap-south-1 cp ansible/content-plugins/$i s3://ekstep-public-$1/content-plugins/$i --acl public-read
done